...
class __TwigTemplate_12f71fbf864d504e6bf513e9383e6830499620f3c3e212e37945169f39756ef1 extends Twig_Template
{
    private $source;
...
";
    ...
    <p id=\"<?php echo \$view->escape(\$id); ?>_help\" <?php echo ' '.\$view['form']->block(\$form, 'attributes', ['attr' => \$help_attr]); ?>><?php echo \$view->escape(false !== \$translation_domain ? \$view['translator']->trans(\$help, [], \$translation_domain) : \$help); ?></p>
<?php endif; ?>
", "@Framework/Form/form_help.html.php", "/Users/devstan/Projects/broadlink-rm/vendor/symfony/framework-bundle/Resources/views/Form/form_help.html.php");
    }
}
